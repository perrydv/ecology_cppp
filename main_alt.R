...
saveRDS(pvalues_inter_alt, "pvalues/alt/interaction.rds")
saveRDS(pvalues_inter_null, "pvalues/null/interaction.rds")
saveRDS(samples_p, "posterior/alt/p_interaction.rds")
saveRDS(samples_beta0, "posterior/alt/beta0_interaction.rds")
saveRDS(samples_beta1, "posterior/alt/beta1_interaction.rds")
