...
model_cov_occ_latent <- nimbleCode({
...
model_cov_occ_det_latent <- nimbleCode({
...
# 4. spatial random effect
model_spatial_ranef_latent <- nimbleCode({
...
fit_basic_latent <- function(compiled_model, compiled_mcmc,
                             niter, nburnin, thin) {
...
fit_cov_occ_latent <- function(compiled_model, compiled_mcmc, ncov,
                               niter, nburnin, thin) {
...
fit_cov_occ_det_latent <- function(compiled_model, compiled_mcmc, ncov_o, 
...
fit_spatial_ranef_latent <- function(compiled_model, compiled_mcmc, region, 
